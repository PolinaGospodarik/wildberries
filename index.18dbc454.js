...
var _catalogJs = require("./catalog.js");
var _searchJs = require("./search.js");
"use strict";
const root = document.querySelector("#root");
const inputSearch = (0, _headerJs.createHeader)(root);
/*MAIN*/ const main = (0, _utilsJs.createElement)("main", "main", null, root);
const containerMain = (0, _utilsJs.createElement)("div", "container", null, main);
const { showSlider, hideSlider } = (0, _sliderJs.createSlider)(containerMain);
const { showCards } = (0, _catalogJs.createCatalog)(containerMain);
(0, _searchJs.createSearch)(inputSearch, showCards, showSlider, hideSlider);

},{"./utils.js":"72Dku","./header.js":"bvS82","./slider.js":"aMYz0","./catalog.js":"jQAFG","./search.js":"4TESp"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createElement", ()=>createElement);
parcelHelpers.export(exports, "createModalWindow", ()=>createModalWindow);
parcelHelpers.export(exports, "setupModalClose", ()=>setupModalClose);
"use strict";
...
function createModalWindow(type, body) {
...
function setupModalClose(modal, closeModalWindow) {
    const modalClose = modal.querySelector(".close");
    function closeModal() {
        modal.style.display = "none";
        if (closeModalWindow) closeModalWindow();
    }
...
var _utilsJs = require("./utils.js");
var _modalShoppingCartJs = require("./modal-shopping-cart.js");
"use strict";
const { openModalCart } = (0, _modalShoppingCartJs.createCart)(document.body);
function createHeader(root) {
    const header = (0, _utilsJs.createElement)("header", "header", null, root);
    const headerContainer = (0, _utilsJs.createElement)("div", "container", null, header);
    const headerNavigation = (0, _utilsJs.createElement)("div", "header__nav", null, headerContainer);
    const logo = (0, _utilsJs.createElement)("span", "header__logo", "Wildberries", headerNavigation);
    const search = (0, _utilsJs.createElement)("div", "header__search", null, headerNavigation);
    const labelSearch = (0, _utilsJs.createElement)("label", null, null, search);
    labelSearch.setAttribute("for", "search");
    const inputSearch = (0, _utilsJs.createElement)("input", null, null, search);
    inputSearch.setAttribute("id", "search");
    inputSearch.setAttribute("placeholder", "\u041D\u0430\u0439\u0442\u0438 \u043D\u0430 Wildberries");
    const button = (0, _utilsJs.createElement)("button", "header__button", null, headerNavigation);
    const buttonIcon = (0, _utilsJs.createElement)("i", "fa-solid", null, button);
...
},{"./utils.js":"72Dku","./modal-shopping-cart.js":"lozsC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lozsC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCart", ()=>createCart);
var _utilsJs = require("./utils.js");
var _cartStorageJs = require("./cart-storage.js");
"use strict";
function createCart(body) {
    const { modal, modalInner } = (0, _utilsJs.createModalWindow)("cart", body);
    const modalContent = (0, _utilsJs.createElement)("div", "cart-content", null, modalInner);
    const modalTitle = (0, _utilsJs.createElement)("h3", "cart-title", "\u0412\u0430\u0448\u0430 \u043A\u043E\u0440\u0437\u0438\u043D\u0430", modalContent);
    const modalList = (0, _utilsJs.createElement)("div", "cart-list", null, modalContent);
    const modalFooter = (0, _utilsJs.createElement)("div", "footer", null, modalInner);
    const totalPriceContainer = (0, _utilsJs.createElement)("div", "total-price", "\u0418\u0442\u043E\u0433\u043E\u0432\u0430\u044F \u0441\u0443\u043C\u043C\u0430: 0 \u0440.", modalFooter);
    const clearButton = (0, _utilsJs.createElement)("button", "clear-button", "\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u043A\u043E\u0440\u0437\u0438\u043D\u0443", modalFooter);
    clearButton.addEventListener("click", function() {
        (0, _cartStorageJs.clearAll)();
        openModalCart();
    });
    function calculateTotalPrice(cartItems, allCards) {
        ...
        cartItems.forEach((cartItem)=>{
            ...
            if (card) totalPrice += card.price * (1 - card.sale * 5 / 100) * cartItem.quantity;
        });
        return totalPrice;
    }
    function updateQuantityDisplay(cartItem, newQuantity, allCards) {
        ...
        totalPriceContainer.textContent = `\u{418}\u{442}\u{43E}\u{433}\u{43E}\u{432}\u{430}\u{44F} \u{441}\u{443}\u{43C}\u{43C}\u{430}: ${totalPrice.toFixed(2)} \u{440}.`;
    }
    function openModalCart() {
        ...
        if (cartItems.length === 0) {
            ...
            totalPriceContainer.textContent = `\u{418}\u{442}\u{43E}\u{433}\u{43E}\u{432}\u{430}\u{44F} \u{441}\u{443}\u{43C}\u{43C}\u{430}: 0 \u{440}.`;
        } else {
            // Получаем данные о карточках из API
            const url = `https://6691928a26c2a69f6e90289e.mockapi.io/wildberries`;
            fetch(url).then((response)=>response.json()).then((allCards)=>{
                cartItems.forEach((cartItem)=>{
                    const card = allCards.find((card)=>card.id === cartItem.id);
                    if (card) {
                        const cardElement = (0, _utilsJs.createElement)("div", "cart-item", null, modalList);
                        cardElement.id = `cart-item-${cartItem.id}`;
                        const title = (0, _utilsJs.createElement)("h3", "cart__title", card.title, cardElement);
                        const price = (0, _utilsJs.createElement)("span", "cart__price", `${(card.price * (1 - card.sale * 5 / 100)).toFixed(2)} \u{440}.`, cardElement);
                        const quantityContainer = (0, _utilsJs.createElement)("div", "quantity__container", null, cardElement);
                        const minusButton = (0, _utilsJs.createElement)("button", "quantity-minus", "-", quantityContainer);
                        const quantity = (0, _utilsJs.createElement)("span", "quantity", cartItem.quantity, quantityContainer);
                        const plusButton = (0, _utilsJs.createElement)("button", "quantity-plus", "+", quantityContainer);
                        const clear = (0, _utilsJs.createElement)("button", "cart__clear", null, cardElement);
                        const clearIcon = (0, _utilsJs.createElement)("i", "fa-solid", null, clear);
                        clearIcon.classList.add("fa-trash-can");
                        clear.addEventListener("click", function() {
                            (0, _cartStorageJs.clearCartItem)(cartItem.id);
                            openModalCart();
                        });
                        minusButton.addEventListener("click", function() {
                            if (cartItem.quantity > 1) {
                                (0, _cartStorageJs.updateItemQuantity)(cartItem.id, cartItem.quantity - 1);
    ...
    restoreModalCart();
    (0, _utilsJs.setupModalClose)(modal, closeModalCart);
    return {
        modal,
        openModalCart
    };
...
},{"./utils.js":"72Dku","./cart-storage.js":"jVHFh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jVHFh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCartItem", ()=>updateCartItem);
parcelHelpers.export(exports, "clearAll", ()=>clearAll);
parcelHelpers.export(exports, "clearCartItem", ()=>clearCartItem);
parcelHelpers.export(exports, "updateItemQuantity", ()=>updateItemQuantity);
"use strict";
function updateCartItem(cardId) {
...
function clearCartItem(cardId) {
    let cartItems = JSON.parse(localStorage.getItem("cartItems")) || [];
    const updateCartItems = cartItems.filter((item)=>item.id !== cardId);
    localStorage.setItem("cartItems", JSON.stringify(updateCartItems));
}
function updateItemQuantity(cardId, quantity) {
    let cartItems = JSON.parse(localStorage.getItem("cartItems")) || [];
    const itemIndex = cartItems.findIndex((item)=>item.id === cardId);
    if (itemIndex !== -1) {
        if (quantity <= 0) cartItems = cartItems.filter((item)=>item.id !== cardId);
        else cartItems[itemIndex].quantity = quantity;
    }
    localStorage.setItem("cartItems", JSON.stringify(cartItems));
}
...
function createSlider(containerMain) {
    // /*СЛАЙДЕР*/
    const slider = (0, _utils.createElement)("section", "slider", null, containerMain);
    const swiperContainer = (0, _utils.createElement)("section", "swiper", null, slider);
    swiperContainer.classList.add("mySwiper");
    const swiperWrapper = (0, _utils.createElement)("div", "swiper-wrapper", null, swiperContainer);
    // Добавляем кнопки навигации и пагинацию
    const swiperButtonNext = (0, _utils.createElement)("div", "swiper-button-next", null, swiperContainer);
    const swiperButtonPrev = (0, _utils.createElement)("div", "swiper-button-prev", null, swiperContainer);
    const swiperPagination = (0, _utils.createElement)("div", "swiper-pagination", null, swiperContainer);
    async function showPicture() {
        ...
        getPhotos().then((data)=>{
            ...
            for(let i = 0; i < data.length; i++){
                const slide = (0, _utils.createElement)("div", "swiper-slide", null, swiperWrapper);
                const img = (0, _utils.createElement)("img", null, null, slide);
                img.src = data[i].imageSlider + `?random=${[
                    i
                ]}`;
...
},{"./utils":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","swiper":"iM6UL","swiper/modules":"9ktz6","swiper/swiper-bundle.min.css":"girFM"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.1.8
...
},{"../shared/create-element-if-not-defined.mjs":"2zeWV","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2zeWV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../shared/ssr-window.esm.mjs":"th8PY","../shared/utils.mjs":"9mU7V","../shared/create-element-if-not-defined.mjs":"2zeWV","../shared/classes-to-selector.mjs":"jlLiZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eHHIn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../shared/ssr-window.esm.mjs":"th8PY","../shared/classes-to-selector.mjs":"jlLiZ","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1zK9H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"girFM":[function() {},{}],"jQAFG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCatalog", ()=>createCatalog);
var _utilsJs = require("./utils.js");
var _modalCardJs = require("./modal-card.js");
var _cartStorageJs = require("./cart-storage.js");
"use strict";
function createCatalog(containerMain) {
    const catalog = (0, _utilsJs.createElement)("section", "catalog", null, containerMain);
    // const catalogTitle = createElement("h2", "catalog__title", "Хиты продаж", catalog);
    const catalogGrid = (0, _utilsJs.createElement)("div", "catalog__grid", null, catalog);
    const noResultsMessage = (0, _utilsJs.createElement)("div", "catalog__no-results", "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E", catalog);
    noResultsMessage.style.display = "none";
    const { openModalCard } = (0, _modalCardJs.createModal)(document.body);
    async function getCards(searchText = "") {
        const url = new URL("https://6691928a26c2a69f6e90289e.mockapi.io/wildberries");
        if (searchText) url.searchParams.append("title", searchText);
    ...
    async function showCards(searchText = "") {
        ...
        if (data.length === 0) noResultsMessage.style.display = "block";
        else {
            noResultsMessage.style.display = "none";
            // Фильтрация данных по заголовку
            // const filteredData = data.filter(item => item.title.toLowerCase().includes(searchText.toLowerCase()));
            for(let i = 0; i < data.length; i++){
                const cardsItem = (0, _utilsJs.createElement)("div", "card", null, catalogGrid);
                cardsItem.setAttribute("id", data[i].id);
                const cardImage = (0, _utilsJs.createElement)("div", "card__img", null, cardsItem);
                const image = (0, _utilsJs.createElement)("img", null, null, cardImage);
                image.src = data[i].picture + `?random=${data[i].id}`;
                const cardViewButton = (0, _utilsJs.createElement)("button", "card__img-button", null, cardImage);
                const imgButtonText = (0, _utilsJs.createElement)("span", "img-button__text", "\u0411\u044B\u0441\u0442\u0440\u044B\u0439 \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440", cardViewButton);
                const imgButtonIcon = (0, _utilsJs.createElement)("i", "fa-solid", null, cardViewButton);
                ...
                cardViewButton.addEventListener("click", async function(event) {
                    ...
                    else console.error("\u0414\u0430\u043D\u043D\u044B\u0435 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B");
                });
                const cardSale = (0, _utilsJs.createElement)("span", "card__sale", null, cardImage);
                const discountPercent = data[i].sale * 5;
                cardSale.textContent = `-${discountPercent}%`;
                const cardPrice = (0, _utilsJs.createElement)("div", "card__price", null, cardsItem);
                const cardPriceSale = (0, _utilsJs.createElement)("span", "card__price-sale", null, cardPrice);
                let discountedPrice = Number(data[i].price) * (1 - discountPercent / 100);
                cardPriceSale.textContent = `${discountedPrice.toFixed(2)} \u{440}.`;
                const cardPriceFull = (0, _utilsJs.createElement)("span", "card__price-full", null, cardPrice);
                cardPriceFull.textContent = `${data[i].price} \u{440}.`;
                const cardTitle = (0, _utilsJs.createElement)("h3", "card__title", null, cardsItem);
                ...
                const cardButton = (0, _utilsJs.createElement)("button", "card__button", "\u041A\u0443\u043F\u0438\u0442\u044C", cardsItem);
                cardButton.addEventListener("click", function(event) {
                    // const currentCard = event.target.closest('.card');
                    const cardId = event.target.closest(".card").id;
                    (0, _cartStorageJs.updateCartItem)(cardId);
                });
            }
        }
    }
...
},{"./utils.js":"72Dku","./modal-card.js":"2yd8E","./cart-storage.js":"jVHFh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2yd8E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createModal", ()=>createModal);
var _utils = require("./utils");
var _cartStorage = require("./cart-storage");
"use strict";
function createModal(body) {
    const { modal, modalInner, modalClose } = (0, _utils.createModalWindow)("card", body);
    const modalLeft = (0, _utils.createElement)("div", "card__left", null, modalInner);
    const modalImage = (0, _utils.createElement)("img", "img", null, modalLeft);
    const modalRight = (0, _utils.createElement)("div", "card__right", null, modalInner);
    const modalTitle = (0, _utils.createElement)("h3", "title", null, modalRight);
    const modalPrice = (0, _utils.createElement)("div", "price", null, modalRight);
    const modalPriceSale = (0, _utils.createElement)("span", "price-sale", null, modalPrice);
    const modalPriceFull = (0, _utils.createElement)("span", "price-full", null, modalPrice);
    const modalDescription = (0, _utils.createElement)("div", "description", null, modalRight);
    const descriptionText = (0, _utils.createElement)("p", null, null, modalDescription);
    const modalButton = (0, _utils.createElement)("button", "button", "\u041A\u0443\u043F\u0438\u0442\u044C", modalRight);
    modalButton.addEventListener("click", function(event) {
        const cardId = event.target.closest(".modal__card").id;
        (0, _cartStorage.updateCartItem)(cardId);
    });
    function openModalCard({ cardId, imageSrc, title, priceSale, price, description }) {
        localStorage.setItem("openCardData", JSON.stringify({
            cardId,
            imageSrc,
            title,
            priceSale,
        ...
        modalPriceSale.textContent = `${priceSale}\u{440}.`;
        modalPriceFull.textContent = `${price}\u{440}.`;
    ...
    restoreModalCard();
    (0, _utils.setupModalClose)(modal, closeModal);
    return {
        modal,
        openModalCard
    };
...
},{"./utils":"72Dku","./cart-storage":"jVHFh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4TESp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createSearch", ()=>createSearch);
"use strict";
function createSearch(inputElement, showCards, showSlider, hideSlider) {
    inputElement.addEventListener("input", function(event) {
        const searchText = event.target.value.trim();
        showCards(searchText);
        if (searchText === "") showSlider();
        else hideSlider();
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j2YDk","1SICI"], "1SICI", "parcelRequireaad3")
