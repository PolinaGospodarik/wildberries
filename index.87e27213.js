 ...
 */ var Swiper = function() {
    ...
    function V(e) {
        ...
        if ("touchmove" === p.type) {
            if (c = [
                ...p.changedTouches
            ].filter((e)=>e.identifier === i.touchId)[0], !c || c.identifier !== i.touchId) return;
        } else c = p;
    ...
    function _(e) {
        ...
        if ("touchend" === i.type || "touchcancel" === i.type) {
            if (a = [
                ...i.changedTouches
            ].filter((e)=>e.identifier === s.touchId)[0], !a || a.identifier !== s.touchId) return;
        } else {
    ...
    const se = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = q.bind(e), e.onTouchMove = V.bind(e), e.onTouchEnd = _.bind(e), e.onDocumentTouchStart = Z.bind(e), t.cssMode && (e.onScroll = U.bind(e)), e.onClick = j.bind(e), e.onLoad = K.bind(e), Q(e, "on");
            },
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = J(e, a), d = J(e, l), c = e.params.grabCursor, u = l.grabCursor, m = a.enabled;
                o && !d ? (i.classList.remove(`${a.containerModifierClass}grid`, `${a.containerModifierClass}grid-column`), e.emitContainerClasses()) : !o && d && (i.classList.add(`${a.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === a.grid.fill) && i.classList.add(`${a.containerModifierClass}grid-column`), e.emitContainerClasses()), c && !u ? e.unsetGrabCursor() : !c && u && e.setGrabCursor(), [
                    "navigation",
                    "pagination",
                    "scrollbar"
                ].forEach((t)=>{
                ...
                const h = l.direction && l.direction !== a.direction, f = a.loop && (l.slidesPerView !== a.slidesPerView || h), g = a.loop;
    ...
    class ie {
        constructor(){
            ...
            const l = this;
            l.__swiper__ = !0, l.support = I(), l.device = A({
                userAgent: t.userAgent
            }), l.browser = z(), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = [
                ...l.__modules__
    ...
    const ge = [
        function(e) {
            ...
            function c(e, t) {
                ...
                if (t && !l && o > 0) return;
                const { addSlidesBefore: c, addSlidesAfter: p } = s.params.virtual, { from: u, to: m, slides: h, slidesGrid: g, offset: v } = s.virtual;
                ...
                const I = l ? -h.length : 0, A = l ? 2 * h.length : h.length;
        ...
        function(e) {
            ...
            function m() {
                ...
                ], s.length > 1 && (s = s.filter((e)=>E(e, ".swiper")[0] === t.el)[0])), Array.isArray(s) && 1 === s.length && (s = s[0]), Object.assign(t.pagination, {
                    el: s
                }), s = T(s), s.forEach((s)=>{
        ...
        function(e) {
            ...
            function O() {
                ...
                t.wrapperEl.addEventListener("pointerdown", T, s), t.wrapperEl.addEventListener("pointermove", M, a), [
                    "pointerup",
                    "pointercancel",
                    "pointerout"
                ].forEach((e)=>{
            ...
            function D() {
                ...
                e.enabled = !1;
                const { passiveListener: s, activeListenerWithCapture: a } = k();
                t.wrapperEl.removeEventListener("pointerdown", T, s), t.wrapperEl.removeEventListener("pointermove", M, a), [
                    "pointerup",
                    "pointercancel",
                    "pointerout"
                ].forEach((e)=>{
...
//# sourceMappingURL=index.87e27213.js.map
